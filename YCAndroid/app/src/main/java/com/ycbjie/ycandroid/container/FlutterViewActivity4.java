 ...
 * @author yc
 */
public class FlutterViewActivity4 extends AppCompatActivity {

    FrameLayout rlFlutter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flutter_view4);
    ...
    private void addFlutterView() {
        ...
        String route = "router_tool?{\"name\":\"杨充\"}";
        //设置初始化路由
