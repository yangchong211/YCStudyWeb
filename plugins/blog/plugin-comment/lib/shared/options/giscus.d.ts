...
export type GiscusMapping = 'url' | 'title' | 'og:title' | 'specific' | 'number' | 'pathname';
export type GiscusInputPosition = 'top' | 'bottom';
export type GiscusTheme = 'light' | 'light_high_contrast' | 'light_protanopia' | 'dark' | 'dark_high_contrast' | 'dark_protanopia' | 'dark_dimmed' | 'transparent_dark' | 'preferred_color_scheme' | `https://${string}`;
