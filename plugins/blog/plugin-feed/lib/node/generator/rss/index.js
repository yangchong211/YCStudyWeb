...
const getRSSEnclosure = (enclosure) => ({
    _attributes: {
        url: enclosure.url,
 ...
 */
export const getRssFeed = (feedStore) => {
     ...
     */
    content.rss.channel.category = Array.from(feedStore.categories).map((category) => ({ _text: category }));
    /**
     * Channel Categories
     *
