...
import 'package:ycflutter/launcher/url_launcher.dart';
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              new Padding(
                ...
                child: new Divider(height: 1.0,color: YcColors.colorLine,),
              ),
              ...
              new Padding(
                padding: const EdgeInsets.symmetric(vertical: 10.0),
                child: new Divider(height: 1,color: YcColors.colorLine,),
              ),
                    ...
                    RichText(
                        text: TextSpan(children: <TextSpan>[
                          TextSpan(
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () {
                                  launch('https://github.com/yangchong211');
                                })
                        ]))
                  ],
                ),
