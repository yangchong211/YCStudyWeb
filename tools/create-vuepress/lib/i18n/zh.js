export const zh = {
    ...
    hint: {
        install: '这可能需要数分钟，请耐心等待.\n我们无法正确输出子进程的进度条，所以进程可能会看似未响应',
        finish: '模板已成功生成!',
        devServer: (packageManager) => `提示: 请使用 "${packageManager} run docs:dev" 命令启动开发服务器`,
    },
    error: {
        ...
        dirMissing: (packageManager) => `你应该指定一个项目文件夹名称，例如 "my-blog", "my-docs"。\n例如: "${packageManager} init vuepress my-docs"`,
        dirNotEmpty: (dir) => `目标文件夹 "${dir}" 不为空，请选择一个空文件夹或者手动删除文件夹中的文件`,
    },
};
