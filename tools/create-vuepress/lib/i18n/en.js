export const en = {
    ...
    hint: {
        install: 'This may take a few minutes, please be patient.\nWe can not correctly output progress bar from child process, so the process may look stuck.',
        finish: 'Successful Generated!',
        devServer: (packageManager) => `Hint: You should execute "${packageManager} run docs:dev" to start dev server.`,
    },
    error: {
        ...
        theme: 'Current theme is not supported yet, using @vuepress/theme-default instead.',
        dirMissing: (packageManager) => `You should specific a folder name for your project, e.g.: "my-blog", "my-docs"\nFor example: "${packageManager} init vuepress my-docs"`,
        dirNotEmpty: (dir) => `Target folder "${dir}" is not empty, please choose an empty folder or delete files in it.`,
    },
};
